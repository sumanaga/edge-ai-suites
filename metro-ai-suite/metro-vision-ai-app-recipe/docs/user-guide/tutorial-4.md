...
We will use the [Smart Parking](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/smart-parking/index.html) application as the existing Metro Vision AI App Recipe-powered application and turn it into an 'AI Crowd Analytics' application.
...
docker run --rm --user=root \
  ...
  intel/dlstreamer:2026.2.0-ubuntu24-rc3 bash -c "$(cat <<EOF
...
- [Metro AI Solutions](https://docs.openedgeplatform.intel.com/2026.2/ai-suite-metro.html)
